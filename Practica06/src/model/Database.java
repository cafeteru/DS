...
public class Database {
	...
	public Collection<Monument> selectMonuments() {
		...
		monumentos.add(new Monument("Coliseo", "Vespasiano",
				"Avenida del Coliseo 1. Roma"));
		monumentos.add(new Monument("Fontana di Trevi", "Niccolo Salvi",
	...
	public Collection<Photo> selectPhotos() {
		...
		fotos.add(new Photo("El Coliseo de noche", "Ra�l",
				new Coordinates(20, 20)));
		fotos.add(new Photo("Un perro mordiendo a un turista", "Ra�l",
	...
	public Collection<Restaurant> selectRestaurant() {
		...
		restaurantes.add(new Restaurant("El Gladiador",
				"Calle del Triunfo 2. Roma", "555 123 456"));
		restaurantes.add(new Restaurant("Mario", "Via della Dataria . Roma",
				"555 123 457"));
		return restaurantes;
	}
}
